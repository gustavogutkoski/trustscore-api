 ...
 *
 * <p>This class allows the construction of type-safe and reusable JPA Specifications based on a
 * provided filter DTO and a mapping function that converts the filter into a list of predicates.
 *
 * <p>The main goal is to encapsulate and abstract the logic of converting filters into JPA criteria
 * predicates, making it easier to build flexible query mechanisms without duplicating boilerplate
 * code.
 *
...
public class GenericSpecBuilder<T, F> {
   ...
   * @param filterSpecFunction a function that converts the filter into an array of {@link

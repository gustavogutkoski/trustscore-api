 ...
 *
 * <p>This class defines a static method to convert a {@link ReviewFilterDTO} into
 * an array of {@link Predicate}, which can be used in a JPA {@link jakarta.persistence.criteria.CriteriaQuery}
 * for dynamic searching.</p>
 *
 * <p>Typical usage involves passing this method as a method reference to a
 * {@code GenericSpecBuilder}, enabling clean and reusable specification construction.</p>
 */
public class ReviewFilterSpecification {

    /**
     * Converts the provided {@link ReviewFilterDTO} into an array of {@link Predicate}s
     * used to filter {@link Review} entities in a criteria query.
     *

...
/**
 * Functional interface representing a function that converts a filter object into an array of JPA {@link Predicate}.
 *
 * <p>This interface is used to abstract the logic of building dynamic query predicates from a filter DTO.
 * It allows the {@code GenericSpecBuilder} to remain generic and reusable by deferring the
 * filter-specific predicate construction to implementations of this interface.</p>
 *
...
public interface FilterSpecificationFunction<F, T> {
     ...
     * @return an array of predicates to be applied in the {@link jakarta.persistence.criteria.CriteriaQuery}
     */
